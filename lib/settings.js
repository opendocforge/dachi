...
export const DEFAULT_SETTINGS = {
  ...
  fewShotLimit: 4,
  doctorContext: "",
  // Raccourcis clavier : action associée à chaque emplacement (Alt+Maj+C / X / R)
  shortcut1: "corriger_reformuler",
  shortcut2: "corriger_seul",
  shortcut3: "resumer",
  // Ancien réglage « action rapide » (Alt+Maj+D) : conservé pour migration vers shortcut1
