...
export const MENU_ITEMS = [
  {
    ...
    prompt: `Tu corriges ET reformules le texte fourni en français professionnel (registre médical et administratif). D'abord l'orthographe, la grammaire et la ponctuation ; puis la fluidité, la clarté et la concision : phrases bien construites, vocabulaire précis, ton courtois et neutre, tournures orales ou familières remplacées par leur équivalent écrit. Tu conserves strictement le sens et tous les faits (chiffres, doses, dates, noms, placeholders comme [NOM 1]) ; tu n'ajoutes aucune information, aucun avis médical, aucune formule de politesse absente de l'original. La longueur reste comparable (au plus ±30 %). Un mot ou une expression isolés sont simplement corrigés. Raccourcis de notes médicales : tu ne développes une abréviation que si son sens est certain (ttt → traitement, rdv → rendez-vous, ds → dans) ; tu conserves telles quelles celles qui sont ambiguës (psy, arrêt, bio, CR…) ; tu ne transformes JAMAIS un raccourci en diagnostic ou en pathologie (« avc » devant un nom ou un pronom signifie « avec », pas AVC) ; tu n'ajoutes aucune précision clinique absente (« bouchon oreille » ne devient pas « bouchon de cérumen »). Les notes en liste numérotée gardent leur structure. En cas de doute, tu conserves la forme d'origine.`,
    examples: [
      { input: "rhinite akkergiuque", output: "rhinite allergique" },
      { input: "1/ suivi psy en cours\ndernier arret puis reprise vu avc patiente\n2/ bouchon oreille gauche", output: "1/ Suivi psy en cours. Dernier arrêt puis reprise, vu avec la patiente.\n2/ Bouchon de l'oreille gauche." },
      { input: "ttt inchangé, rdv ds 3 mois, bio ok", output: "Traitement inchangé, rendez-vous dans 3 mois, biologie OK." },
      { input: "le patient se plein de mots de tete depui 3 jour, il a pri du doliprane sa a pas marché", output: "Le patient se plaint de céphalées depuis 3 jours, non soulagées par la prise de Doliprane." },
      { input: "bonjour je vous adresse mme [NOM 1] pour un avis car elle a des douleurs au genoux droit depuis 2 mois qui augmente a la marche et je sais pas trop quoi faire", output: "Bonjour,\n\nJe vous adresse Mme [NOM 1] pour avis concernant des douleurs du genou droit évoluant depuis deux mois, majorées à la marche, dont la prise en charge me pose question." },
      { input: "merci de faire le necessaire pour le renouvellement de l'ordonance de mme [NOM 1] qui est en rupture de traitement depuis hier", output: "Merci de bien vouloir procéder au renouvellement de l'ordonnance de Mme [NOM 1], en rupture de traitement depuis hier." }
    ]
  },
  {
    id: "corriger_seul",
    title: "🔤 Corriger seulement",
    prompt: `Tu es un correcteur orthographique strict. Tu reçois un texte et tu renvoies UNIQUEMENT ce même texte avec les fautes d'orthographe, de grammaire et de ponctuation corrigées. Tu ne reformules pas, tu ne changes ni le style ni l'ordre des phrases, tu ne définis pas, tu n'expliques pas, tu n'ajoutes aucune information. Les abréviations et raccourcis (psy, ttt, rdv, bio…) restent tels quels ; « avc » devant un nom ou un pronom est le mot « avec » mal tapé, jamais AVC. Ta sortie a la même longueur que l'entrée.`,
    examples: [
      { input: "rhinite akkergiuque", output: "rhinite allergique" },
      { input: "dernier arret puis reprise vu avc patiente", output: "Dernier arrêt puis reprise, vu avec patiente." },
  ...
  },
  {
    ...
    form: {
      intro: "Le texte sélectionné sert de données sources (ancien courrier, compte-rendu, dossier). Précisez à qui et pourquoi vous adressez le patient, et cochez ce qui ne doit pas être repris (examen clinique périmé, résultats anciens…) : le courrier sera rédigé à partir des deux.",
      ...
      fields: [
        ...
        { key: "exclure", label: "Ne pas reprendre des données sources", type: "checkboxes",
          options: ["Examen clinique (obsolète)", "Constantes / mesures datées", "Résultats d'examens anciens", "Traitements arrêtés / anciens", "Conclusion ou diagnostic antérieur", "Éléments administratifs (rendez-vous, courriers)"] },
        { key: "ignorer", label: "Autres éléments à ignorer", type: "text", placeholder: "Ex : le bilan de 2021, la mention du sevrage tabagique…" },
