...
export const MENU_ITEMS = [
  ...
  },
  {
    ...
    // Formulaire posé AVANT la génération : les réponses sont ajoutées au texte
    // sélectionné (ancien courrier, compte-rendu) sous forme de consignes.
    form: {
      ...
      fields: [
        { key: "destinataire", label: "Destinataire", type: "text", placeholder: "Dr Durand / Service de cardiologie du CH de…", required: true, width: "half" },
        { key: "specialite", label: "Spécialité", type: "text", placeholder: "Cardiologie", width: "half",
  ...
  },
  {
    ...
    form: {
      ...
      submitLabel: "Rédiger le courrier",
      fields: [
        { key: "destinataire", label: "Destinataire", type: "text", placeholder: "Dr Durand / Service de cardiologie du CH de…", required: true },
